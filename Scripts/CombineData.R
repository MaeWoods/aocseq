...
#' @param demultiplex A \code{\link{ModalityWeights}} object generated by
...
dir_vdj1,dir_vdj2,dir_vdj3,dir_vdj4,marker.gene,mask,save.dir)

save.dir="../RDS/SixHourStim.rds"
...
clonotypes.nucleic.acid=data.frame(TCRs=IMTCRs[[q]],clonoT=Nclono[[q]],freqT=SizesMono[[q]])
for(j in 1:dim(Clonal_Obs[[k]])[2]){
...
Clonal_Obs[[k]]=AddMetaData(Clonal_Obs[[k]], all.Cname, col.name = 'clonotype')
Clonal_Obs[[k]]=AddMetaData(Clonal_Obs[[k]], all.Size, col.name = 'countcln')
}
