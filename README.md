...
**aocseq** is a suite of statistical tools that are publically available for the analysis of multimodal immunosequencing data and that can be used to predict and trace recently stimulated T cells in the blood with their gene expression transcripts. 
