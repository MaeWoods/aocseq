...
Immunosequencing is a multiplex PCR-based based method that exploits the capacity of high-throughput sequencing (HTS) technology to characterize tens of thousands of TCR CDR3 chains simultaneously.
