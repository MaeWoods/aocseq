...
**VRTrack** is software for the analysis of immunosequencing data and can be used for the prediction of antigen specific T cells amongst the masses. The package was developed by the department of Cell and Gene Therapy at Baylor College of Medicine. For a full list of authors who contributed to the software design and application, please see the manuscript: ...
