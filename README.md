...
**VRTrack** is software to analyze immunosequencing data written in R and Rcpp for the prediction of antigen specific T cells from the masses. The package was developed by the department of Cell and Gene Therapy at Baylor College of Medicine. For a full list of authors who contributed to the software design and application, please see the manuscript: ...
