...
**VRTrack** is software for the analysis of immunosequencing data and can be used to predict antigen specific T cells amongst others . The package was developed by the department of Cell and Gene Therapy at Baylor College of Medicine. For a full list of authors who contributed to the software design and application, please see the manuscript: ...
